 ...
 * @author leonh
 */
public class BrockScreen extends javax.swing.JFrame {

    /**
     * Creates new form BrockScreen
     */
    public BrockScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        entei = new javax.swing.JLabel();
        sceptile = new javax.swing.JLabel();
        pikachu = new javax.swing.JLabel();
        feraligtr = new javax.swing.JLabel();
        brock_background = new javax.swing.JLabel();
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 350, -1, -1));

        jButton3.setText("Move 3");
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 350, -1, -1));

        jButton4.setText("Move 4");
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 350, -1, -1));

        logout.setText("Logout");
        getContentPane().add(logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, -1, -1));

        entei.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Sem Título-2.png"))); // NOI18N
        getContentPane().add(entei, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, 80, 80));

        sceptile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/sceptile.png"))); // NOI18N
        getContentPane().add(sceptile, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, -1, -1));

        pikachu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pikachu-f.png"))); // NOI18N
        pikachu.setToolTipText("");
        getContentPane().add(pikachu, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, 80, 60));

        feraligtr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/feraligatr.png"))); // NOI18N
        getContentPane().add(feraligtr, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, -1, -1));

        brock_background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/d5nwldw-186afcb8-332f-4892-9366-4637673e1ae9.png"))); // NOI18N
        brock_background.setDisabledIcon(null);
        getContentPane().add(brock_background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrockScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrockScreen().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel brock_background;
    private javax.swing.JLabel entei;
    ...
    private javax.swing.JLabel sceptile;
    // End of variables declaration//GEN-END:variables

    public void BrockBattleBegins() {
        //TYPES
