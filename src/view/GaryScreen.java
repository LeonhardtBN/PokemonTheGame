 ...
 * @author leonh
 */
public class GaryScreen extends javax.swing.JFrame {

    /**
     * Creates new form GaryScreen
     */
    public GaryScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(pikachu, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 80, 60));

        feraligtr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/feraligatr.png"))); // NOI18N
        getContentPane().add(feraligtr, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pigeot.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/magmamortar.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/backgroundgary.png"))); // NOI18N
        jLabel2.setMaximumSize(new java.awt.Dimension(475, 400));
        jLabel2.setMinimumSize(new java.awt.Dimension(475, 400));
        jLabel2.setPreferredSize(new java.awt.Dimension(475, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GaryScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GaryScreen().setVisible(true);
            }
        });
    }
    ...
    //Essa função instacia todos os movimentos e
   public void GaryBattleBegins() {
        //TYPES
